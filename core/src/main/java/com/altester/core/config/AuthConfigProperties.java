...
public class AuthConfigProperties {
  ...
  /**
   * Authentication mode determines which authentication methods are available. Possible values: -
   * ALL: All methods (LDAP + standard login + registration) - STANDARD_ONLY: Only standard
   * authentication (login + registration always together) - LDAP_ONLY: Only LDAP authentication
   */
  @Value("${auth.mode:ALL}")
