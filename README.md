Сделать бэтч запрсоов и сгруппировать. Подставлять промпт исходя из респонса.
Возвращать чтото на кор.
Добавить енам для разных провайдеров и их моделей при создани.

Поиграть с уведмолениями, в конце концов чатик доделать.
