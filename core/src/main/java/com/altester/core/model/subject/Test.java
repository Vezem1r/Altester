...
public class Test {
  ...
  @Column private Integer maxAttempts;

  @Column private Integer easyQuestionsCount = 0;

  @Column private Integer mediumQuestionsCount = 0;
  ...
  public int getTotalScore() {
    Map<QuestionDifficulty, List<Question>> grouped =
        questions.stream().collect(Collectors.groupingBy(Question::getDifficulty));

    Map<QuestionDifficulty, Integer> difficultyCountMap =
        Map.of(
