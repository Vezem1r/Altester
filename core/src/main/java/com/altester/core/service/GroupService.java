...
public interface GroupService {
   ...
   */
  CacheablePage<GroupsResponse> getAllGroups(
      int page,
      int size,
      String searchQuery,
   ...
   * creation/modification to select which students to add.
   *
  ...
  /**
   * Retrieves a paginated and searchable list of all teachers in the system. Used for group
   * creation/modification to select a teacher for the group.
   *
   * @param page Page number (zero-based)
   * @param size Number of items per page
