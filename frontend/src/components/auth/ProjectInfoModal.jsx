              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6">
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 sm:p-6 rounded-xl sm:rounded-2xl">
                  ...
                  <p className="text-purple-700 text-xs sm:text-sm leading-relaxed">
                    Comprehensive educational platform built with microservices architecture. 
                    Combines traditional assessment with cutting-edge AI evaluation capabilities, 
                    streamlining the entire test lifecycle from creation to grading.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 sm:p-6 rounded-xl sm:rounded-2xl">
                  ...
                  <div className="space-y-1">
                    <div className="text-blue-700 text-xs sm:text-sm">• Authorization Service</div>
                    <div className="text-blue-700 text-xs sm:text-sm">• Chat Service</div>
                    <div className="text-blue-700 text-xs sm:text-sm">• Notification Service</div>
                    <div className="text-blue-700 text-xs sm:text-sm">• AI Grading Service</div>
                    <div className="text-blue-700 text-xs sm:text-sm">• Core Service</div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-4 sm:p-6 rounded-xl sm:rounded-2xl">
                  ...
                  <div className="space-y-0.5">
                    <div className="text-orange-700 text-xs sm:text-sm">• AI-Powered Grading</div>
                    <div className="text-orange-700 text-xs sm:text-sm">• Real-time Communication</div>
                    <div className="text-orange-700 text-xs sm:text-sm">• LDAP Integration</div>
                    <div className="text-orange-700 text-xs sm:text-sm">• Advanced Test Management</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-4 sm:p-6 rounded-xl sm:rounded-2xl text-white">
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div>
                    <div className="text-sm font-semibold text-gray-300 mb-1">Backend</div>
                    <div className="text-xs text-gray-400">Java 21 • Spring Boot 3.4.5</div>
                    <div className="text-xs text-gray-400">PostgreSQL • Redis • WebSockets</div>
                  </div>
                  <div>
                    <div className="text-sm font-semibold text-gray-300 mb-1">Frontend</div>
                    <div className="text-xs text-gray-400">React • Tailwind CSS</div>
                    <div className="text-xs text-gray-400">WebSocket Client</div>
                  </div>
                  <div>
                    <div className="text-sm font-semibold text-gray-300 mb-1">AI Integration</div>
                    <div className="text-xs text-gray-400">LangChain4j • OpenAI</div>
                    <div className="text-xs text-gray-400">Anthropic • Google Gemini</div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col items-center justify-between space-y-4 sm:space-y-0 sm:flex-row">
              <div className="text-center sm:text-left">
                ...
                <p className="text-gray-500 text-xs">
                  Microservices • AI Integration • Real-time Communication
                </p>
              </div>
