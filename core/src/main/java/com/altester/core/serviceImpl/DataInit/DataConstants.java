...
public class DataConstants {
    ...
    public static final List<String> FIRSTNAMES = Arrays.asList(
    ...
    public static final List<String> GROUP_NAME_FORMATS = Arrays.asList(
            "CS-%d%s", // CS-1A
            "INF-%d%d%d", // INF-101
            "GROUP-%d%s", // GROUP-1A
            "%dIT%d", // 1IT1
    ...
    public static final List<String> SHORT_NAMES = Arrays.asList(
            "ICS", "PF", "DSA", "DBS", "CN", "OS", "WD",
            "SE", "AI", "CG", "MAD", "IS", "CC",
            "ML", "HCI", "CA", "DS", "BDA", "FLA", "OOP"
    );

    public static final List<String> TEST_TITLES_PROGRAMMING = Arrays.asList(
    ...
    public static final List<String> TEST_TITLES_DATABASES = Arrays.asList(
    ...
    public static final List<String> TEST_TITLES_NETWORKS = Arrays.asList(
    ...
    public static final List<String> TEST_TITLES_OS = Arrays.asList(
            "Process Management",
    ...
    public static final List<String> TEST_TITLES_AI = Arrays.asList(
            "Search Algorithms",
    ...
    public static final List<String> TEST_TITLES_SE = Arrays.asList(
    ...
    public static final List<String> CODING_QUESTIONS = Arrays.asList(
    ...
    public static final List<String> DATABASE_QUESTIONS = Arrays.asList(
    ...
    public static final List<String> NETWORKING_QUESTIONS = Arrays.asList(
    ...
    public static final List<List<String>> MULTIPLE_CHOICE_OPTIONS_JAVA = Arrays.asList(
            Arrays.asList("public static void main(String[] args)", "public void main(String[] args)", "public static main(String[] args)", "public static void main()"),
            Arrays.asList("int x = 5;", "integer x = 5;", "Int x = 5;", "int x: 5;"),
            Arrays.asList("ArrayList", "LinkedList", "Vector", "Stack"),
            Arrays.asList("try-catch-finally", "try-except-finally", "try-catch-end", "try-except-end"),
    ...
    public static final List<List<String>> MULTIPLE_CHOICE_OPTIONS_DB = Arrays.asList(
    ...
    public static final List<String> TEST_DESCRIPTIONS = Arrays.asList(
