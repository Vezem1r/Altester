...
public interface UserPassService {
  ...
  /**
   * Initiates the password reset process for a user. Validates the user account, generates a reset
   * code, and sends it to the user's registered email address.
   *
  ...
  /**
   * Completes the password reset process using the verification code. Validates the provided code
  ...
  /**
   * Resends the password reset code to the user's email. Generates a new reset code and sends it if
   * enough time has passed since the previous code was sent.
   *
