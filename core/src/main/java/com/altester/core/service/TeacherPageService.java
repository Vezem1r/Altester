...
public interface TeacherPageService {
    ...
    /**
     * Retrieves the teacher dashboard data including all subjects and groups
    ...
    /**
     * Retrieves a paginated and searchable list of all unique students
     * enrolled in the teacher's active groups.
     *
     * @param principal The authenticated teacher
    ...
    /**
     * Retrieves a paginated and searchable list of all groups assigned to the teacher,
     * with optional filtering by status (active, inactive, future).
     *
     * @param principal The authenticated teacher
     * @param page Page number (zero-based)
     * @param size Number of items per page
     * @param searchQuery Optional search text to filter groups by name
     * @param statusFilter Optional filter by group status ("active", "inactive", "future", or null for all)
     ...
     * Both groups must be taught by the same teacher and belong to the same subject.
     *
     * @param principal The authenticated teacher
