...
public interface TestService {
    ...
    /**
     * Toggles AI evaluation for a specific test and group combination.
     * Requires an API key to be already assigned to the test-group pair.
     *
    ...
    /**
     * Retrieves a paginated and searchable list of all tests for administrators,
    ...
    /**
     * Retrieves a paginated and searchable list of tests for a teacher,
     * with optional filtering by active status and edit permission.
     * Only includes tests associated with groups where the teacher is assigned.
     *
     * @param pageable Pagination information
     ...
     * Automatically assigns a global API key if available.
     *
    ...
    /**
     * Retrieves detailed preview information for a specific test,
     * including questions and configuration.
     *
     * @param testId ID of the test to retrieve
     * @param principal The authenticated user
    ...
    /**
     * Retrieves a paginated and searchable list of tests associated with a specific subject.
     * For teachers, only includes tests in groups they teach.
     *
     ...
     * When a test is opened, notifications are sent to all students in associated groups.
     *
