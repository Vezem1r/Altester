...
public interface AttemptRetrievalService {
    ...
    /**
     * Retrieves test attempts grouped by student groups for a specific test, accessible only to administrators.
     * Includes attempts from all groups associated with the test.
     *
    ...
    /**
     * Retrieves all test attempts made by a specific student in groups taught by the authenticated teacher.
     * Only includes attempts for groups where the teacher is assigned and the student is a member.
     *
     * @param principal The authenticated teacher
     ...
     * Accessible to teachers who teach the group the student belongs to, and administrators.
     *
     ...
     * @throws AccessDeniedException if the authenticated user doesn't have permission to access this attempt
     */
    AttemptReviewDTO getAttemptReview(Principal principal, Long attemptId);

    /**
     * Submits a review for a specific test attempt.
     * Accessible to teachers who teach the group the student belongs to, and administrators.
     *
     * @param principal The authenticated user (teacher or administrator)
