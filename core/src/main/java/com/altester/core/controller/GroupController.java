...
public class GroupController {
  ...
  public ResponseEntity<Page<GroupsResponse>> getAllGroups(
    ...
    log.debug(
        "Fetching groups with page={}, size={}, searchQuery={}, activityFilter={}, available={}, subjectId={}",
        page,
        size,
        searchQuery,
        activityFilter,
    ...
    CacheablePage<GroupsResponse> groups =
        groupService.getAllGroups(page, size, searchQuery, activityFilter, available, subjectId);
  ...
  public ResponseEntity<Page<GroupUserList>> getAllTeachers(
      ...
      @RequestParam(required = false) String searchQuery) {
    log.debug(
        "Fetching all teachers with page={}, size={}, searchQuery={}", page, size, searchQuery);
  ...
  public ResponseEntity<GroupStudentsResponseDTO> getGroupStudents(
    ...
    GroupStudentsResponseDTO result =
        groupService.getGroupStudentsWithCategories(
