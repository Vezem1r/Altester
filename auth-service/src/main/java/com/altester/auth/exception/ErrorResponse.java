...
public class ErrorResponse {
  ...
  public static ErrorResponse from(AuthException exception) {
    ...
    ErrorResponse response =
        new ErrorResponse(exception.getErrorCode().getCode(), sanitizedMessage);
  ...
  private static String getSanitizedMessage(AuthException exception) {
    return switch (exception) {
      ...
      case VerificationCodeExpiredException ignored1 ->
          "The verification code has expired. Please request a new one";
      case PasswordResetCodeExpiredException ignored ->
          "The verification code has expired. Please request a new one";
