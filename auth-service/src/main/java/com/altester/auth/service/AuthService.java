...
public interface AuthService {
     ...
     * Creates a new user account in disabled state and sends a verification
     * email with a confirmation code to complete registration.
     *
     ...
     * @throws CodeRequestTooSoonException if the user tries to register again too soon after a previous attempt
     */
    void register(RegisterUserDTO registerUserDTO);

    /**
     * Authenticates a user and generates an authentication token.
     * Validates user credentials, updates last login time, and generates
     * a JWT token for authenticated session.
     *
    ...
    /**
     * Verifies a user account using the provided verification code.
     * Checks the code validity and expiration, then enables the account if valid.
     *
     ...
     * if the previous code is expired or if enough time has passed since
     ...
     * @throws CodeRequestTooSoonException if the request is made too soon after a previous code was sent
     */
