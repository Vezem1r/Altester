...
public class StudentPageController {
  ...
  public ResponseEntity<StudentDashboardResponse> getStudentDashboard(
    ...
    StudentDashboardResponse dashboard =
        studentService.getStudentDashboard(principal, searchQuery, groupId);
  ...
  public ResponseEntity<AcademicHistoryResponse> getAcademicHistory(
      ...
      @RequestParam(required = false) String searchQuery) {
    AcademicHistoryResponse history =
        studentService.getAcademicHistory(principal, academicYear, semester, searchQuery);
  ...
  public ResponseEntity<StudentAttemptsResponse> getStudentTestAttempts(
